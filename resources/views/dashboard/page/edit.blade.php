@extends('dashboard.layouts.master',['title'=>'تعديل صفحة '])
@section('content')
@push('css')
...
@endpush
    ...
    <!-- widgets -->
    <form action="{{route('dashboard.page.update',$page->id)}}"method="post" enctype="multipart/form-data" id="form">
        @csrf
        <div class="row">
