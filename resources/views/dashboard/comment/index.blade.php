@extends('dashboard.layouts.master',['title'=>'التعليقات'])
@section('content')
            ...
            <form id="form" action="#">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-3 col-form-label">كاتب التعليق</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                               <textarea  readonly class="form-control"  name="body" id="body">
                               </textarea>
                            </div>
                        </div>
